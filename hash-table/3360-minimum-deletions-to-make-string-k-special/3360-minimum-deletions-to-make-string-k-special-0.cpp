...
public:
    int minimumDeletions(string word, int lim) {
        ...
        hint 2 says it better :
            in the actual solution: the minimum freq guy was never deleted.
            better explanation of what i'm doing , iterating over this min freq guy
        */
        int n = word.size();
        vector<int>occ(26);
